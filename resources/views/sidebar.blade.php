        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu" style="display: none">
                    ...
                    <li @if($titPagina == 'Relatórios') class="active" @endif><a href="{{ route('relatorios.listaProva') }}"><span>Competidores na Prova</span></a></li>
                    ...
                    <li @if($titPagina == 'Relatórios') class="active" @endif><a href="{{ route('relatorios.contas') }}"><span>Prestação de Contas</span></a></li>
                </ul>
            </li>
        </ul>
    </section>
