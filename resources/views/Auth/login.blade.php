...
<div class="login-box">
    <div class="login-logo">
        <a href="/"><b>SI</b><spam class="bg-blue"><em>GEL</em></spam></a>
    </div>
    <div class="login-box-body">
        ...
        {!! Form::open(['route' => 'auth.login', 'method' => 'post']) !!}
            ...
            <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="Email" name="email" value="{{ old('email') }}" id="email" />
